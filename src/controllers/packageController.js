...
// --- Função para ATUALIZAR uma embalagem ---
const updatePackage = async (req, res) => {
    try {
        ...
        res.status(400).json({ message: 'Erro ao atualizar embalagem.', error });
    }
};

// --- Função para BUSCAR uma embalagem específica pelo ID ---
const getPackageById = async (req, res) => {
    try {
        ...
        res.status(500).json({ message: 'Erro ao buscar embalagem.', error });
    }
};
